...
const ActivityPerformance = ({ overviewSelect }) => {
  const { id } = useParams();
  ...
  const fetchData = async () => {
    try {
      const response = await useApi('get-app-info-performances', formData);
              ...
              <div className='text-box'>
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      activityPerformanceData?.app_info_performance_est_earnings,
                  }}
                />
              </div>
            ...
            <div className='scorecard'>
              <div className='text-box'>
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      activityPerformanceData?.app_info_performance_requests,
                  }}
                />
              </div>
              <div className='line-chart'>
            ...
            <div className='scorecard'>
              <div className='text-box'>
                <div
                  className='label-value'
                  dangerouslySetInnerHTML={{
                    __html: activityPerformanceData?.app_info_performance_impr,
                  }}
                />
              </div>
              <div className='line-chart'>
            ...
            <div className='scorecard'>
              <div className='text-box'>
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      activityPerformanceData?.app_info_performance_match_rate,
                  }}
                />
              </div>
              <div className='line-chart'>
            ...
            <div className='scorecard'>
              <div className='text-box'>
                <div
                  className='label-value'
                  dangerouslySetInnerHTML={{
                    __html: activityPerformanceData?.app_info_performance_ecpm,
                  }}
                />
              </div>
              <div className='line-chart'>
